...
export function Globe({
    ...
    arcs = [],
    className = "",
    markerColor = [0.51, 0.55, 0.97],
    baseColor = [0.09, 0.12, 0.22],
    arcColor = [0.51, 0.55, 0.97],
    glowColor = [0.35, 0.4, 0.9],
    dark = 1,
    mapBrightness = 3.5,
    markerSize = 0.03,
    ...
    useEffect(() => {
        ...
        mapBrightness, markerSize, markerElevation, arcWidth, arcHeight, speed, theta, diffuse,
        mapSamples])
                ...
                >
                    ...
                    <span
                        style={{
                            ...
                            borderTopColor: "rgba(17, 23, 34, 0.9)",
                        }}
                    />
                </div>
            ))}
